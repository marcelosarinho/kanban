<div
    class="p-4 border border-l-4 border-blue-500 rounded-md bg-white dark:bg-slate-800 dark:border-blue-700 dark:text-gray-300">
    <header class="flex justify-between items-center">
        <x-card-category-badge label="Badge" />
    ...
    <div class="flex justify-between items-end my-3">
        <div class="flex items-center gap-1">
            ...
            <label class="text-sm" for="teste">Concluída</label>
        </div>
