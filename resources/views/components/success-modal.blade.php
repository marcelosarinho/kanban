<div class="hidden absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 size-full bg-black/35">
  <div class="w-1/2 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-5 rounded flex flex-col
    ...
    <footer>
      <x-button id="teste" type="button" color="bg-red-500" textColor="text-black">Fechar</x-button>
    </footer>
  </div>
</div>