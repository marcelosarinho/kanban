...
export default function Login() {
  ...
  return (
    <main className="flex justify-center items-center h-screen">
      {formType === 'login' && (
        <div className="border rounded-lg dark:bg-slate-900 dark:border-slate-700">
          <div className="border-b dark:border-slate-700 p-6">
            <h1 className="text-center dark:text-gray-300 text-2xl font-bold">Login</h1>
          </div>
      ...
      {formType === 'register' && (
        <div className="border rounded-lg dark:bg-slate-900 dark:border-slate-700">
          <div className="border-b dark:border-slate-700 p-6">
            <h1 className="text-center dark:text-gray-300 text-2xl font-bold">Cadastre-se</h1>
          </div>
          <form className="p-6" action="">
            <fieldset className="flex flex-col gap-4">
      ...
      {formType === 'forgot-password' && (
        <div className="border rounded-lg dark:bg-slate-900 dark:border-slate-700">
          <div className="border-b dark:border-slate-700 p-6">
            <h1 className="text-center dark:text-gray-300 text-2xl font-bold">Esqueceu a senha?</h1>
          </div>
          <form className="p-6" action="">
