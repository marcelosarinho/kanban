    ...
    <>
      ...
      <aside className="fixed w-52 bg-white h-full border-r border-gray-300 dark:bg-slate-900 dark:border-slate-700">
        <div className="flex flex-col items-center px-2">
          ...
          <div
            className="has-focus-visible:border has-focus-visible:border-primary mt-6 rounded py-0.5 px-1 bg-gray-50 h-fit flex items-center justify-end border border-gray-300 dark:bg-slate-800 dark:border-slate-700 w-full focus-visible:border-primary"
          >
