  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-end">
        <Button
          id={`edit_${underscoredProjectName}`}
          variant="transparent"
          onClick={() => openModal('create-project-modal', project, true)}
          icon={PencilSimpleIcon}
          iconClassName="text-lg text-info transition-colors"
        >
          <CustomTooltip anchorSelect={`#edit_${underscoredProjectName}`} content="Editar" />
        </Button>
        <Button
          id={`delete_${underscoredProjectName}`}
          variant="transparent"
          onClick={() => openModal('delete-project-modal', project)}
          icon={TrashIcon}
          iconClassName="text-lg text-danger transition-colors"
        >
