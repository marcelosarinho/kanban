...
export default function ThemeButton(props: ThemeButtonProps) {
  ...
  return (
    <div className={className}>
      ...
      {themeDropdown && (
        <div className={`absolute bg-white rounded-md mt-2 p-2 w-28 text-sm border border-gray-300 dark:bg-slate-900 dark:border-slate-700 dark:text-gray-300 select-none animate-dropdown ${dropdownClassName}`}>
